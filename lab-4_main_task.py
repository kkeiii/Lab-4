...
for combo in combinations:
        ...
        for item in required_items:
            ...
            if total_points > max_points:
                ...
                best_combo = combo
                all_combinations.append((combo, total_points))
...
if all_combinations:
    print(f"Найдено {len(all_combinations)} комбинаций с положительным счётом:")
    for combo, points in all_combinations:
        print(f"{combo}, Общий счёт: {points}")
else:
    print("Не найдено комбинаций с положительным счётом")
